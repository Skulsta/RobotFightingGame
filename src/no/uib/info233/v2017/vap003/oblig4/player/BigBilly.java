...
public class BigBilly extends Player {

	public BigBilly(String name) {
		super(name);
	}
	
	
	/**
	 * Override method in order to make this subclass less aggressive than the standard class.
	 * He will use between 0 and half of his remaining energy points when
	...
	public void makeNextMove (int currentPosition, int yourEnergy, int opponentEnergy) {
		...
		// Fighting on the middle circles of the field. That is; circle 1, 2 and 3.
			if (currentPosition < 4 && currentPosition > 0) {
					result = rand.nextInt((result + 1)/2) + (0);	// Be unpredictable. Spend between 0 and half of your remaining energy points.
